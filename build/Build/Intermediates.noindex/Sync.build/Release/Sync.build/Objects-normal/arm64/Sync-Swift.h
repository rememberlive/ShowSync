...
@class NSApplication;
SWIFT_CLASS("_TtC4Sync11AppDelegate")
...
- (NSApplicationTerminateReply)applicationShouldTerminate:(NSApplication * _Nonnull)sender SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Sync17BonjourAdvertiser")
@interface BonjourAdvertiser : NSObject
...
@class NSString;
@class NSNumber;
@interface BonjourAdvertiser (SWIFT_EXTENSION(Sync)) <NSNetServiceDelegate>
- (void)netServiceDidPublish:(NSNetService * _Nonnull)sender;
- (void)netService:(NSNetService * _Nonnull)sender didNotPublish:(NSDictionary<NSString *, NSNumber *> * _Nonnull)errorDict;
@end

SWIFT_CLASS("_TtC4Sync14BonjourBrowser")
...
@interface BonjourBrowser (SWIFT_EXTENSION(Sync)) <NSNetServiceBrowserDelegate>
...
@interface BonjourBrowser (SWIFT_EXTENSION(Sync)) <NSNetServiceDelegate>
